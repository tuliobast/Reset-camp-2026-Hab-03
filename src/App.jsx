...
const PARTICIPANTS = [
  { id: 1, name: "Antonella Moyano", role: "Edad: 19", img: "./Antonella_Moyano-removebg-preview.png" },
  { id: 2, name: "Ayelen Valle", role: "Edad: 32", img: "./Ayelen_Valle-removebg-preview.png" },
  { id: 3, name: "Aylen Alvarado", role: "Edad: 20", img: "./Aylen_Alvarado-removebg-preview.png" },
  { id: 4, name: "Candela Ortiz", role: "Edad: 27", img: "./Candela_Ortiz-removebg-preview.png" },
  { id: 5, name: "Clara Fernandez", role: "Edad: 14", img: "./Clara_Fernandez-removebg-preview.png" },
  { id: 6, name: "Elena Hermoso", role: "Edad: 17", img: "./Elena_Hermoso-removebg-preview.png" },
  { id: 7, name: "Eliana Moreno", role: "Edad: 27", img: "./Eliana_Moreno-removebg-preview.png" },
  { id: 8, name: "Florencia Ledezma", role: "Edad: 20", img: "./Flor-removebg-preview.png" },
  { id: 9, name: "Iara Leañez", role: "Edad: 20", img: "./Iara_Leañez-removebg-preview.png" },
  { id: 10, name: "Magali Laguia", role: "Edad: 17", img: "./Magali_Laguia-removebg-preview.png" },
  { id: 11, name: "Mia Moreno", role: "Edad: 16", img: "./Mia_Moreno-removebg-preview.png" },
  { id: 12, name: "Morena Zarate", role: "Edad: 14", img: "./Morena_Zarate-removebg-preview.png" },
  { id: 13, name: "Rebeca Bolla", role: "Edad: 18", img: "./Rebeca_Bolla-removebg-preview.png" },
  { id: 14, name: "Rocio Garay", role: "Edad: 14", img: "./Rocio_Garay-removebg-preview.png" },
  { id: 15, name: "Sofia Castillo", role: "Edad: 13", img: "./Sofia_Castillo-removebg-preview.png" },
  { id: 16, name: "Tiara Gomez", role: "Edad: 14", img: "./Tiara_Gomez-removebg-preview.png" },
];
